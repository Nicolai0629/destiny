...
export const Footer = () => {
  return (
    <footer className="bg-gray-900 py-12">
      <div className="max-w-[1312px] mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
        <div>
          <div className="mb-2">
            <svg width="33" height="33" viewBox="0 0 33 33" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M16.9336 2.98389L3.60022 9.65055L16.9336 16.3172L30.2669 9.65055L16.9336 2.98389ZM3.60022 22.9839L16.9336 29.6506L30.2669 22.9839M3.60022 16.3172L16.9336 22.9839L30.2669 16.3172" fill="#6366F1"></path>
            </svg>
          </div>
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-3">
              <svg width="20" height="20" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-indigo-400 flex-shrink-0">
                <path d="M3.43359 6.91406L10.0086 11.2974C10.2825 11.4801 10.6043 11.5776 10.9336 11.5776C11.2628 11.5776 11.5847 11.4801 11.8586 11.2974L18.4336 6.91406M5.10026 16.0807H16.7669C17.209 16.0807 17.6329 15.9051 17.9454 15.5926C18.258 15.28 18.4336 14.8561 18.4336 14.4141V6.08073C18.4336 5.6387 18.258 5.21478 17.9454 4.90222C17.6329 4.58966 17.209 4.41406 16.7669 4.41406H5.10026C4.65823 4.41406 4.23431 4.58966 3.92175 4.90222C3.60919 5.21478 3.43359 5.6387 3.43359 6.08073V14.4141C3.43359 14.8561 3.60919 15.28 3.92175 15.5926C4.23431 15.9051 4.65823 16.0807 5.10026 16.0807Z" stroke="#6366F1" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round"></path>
              </svg>
      ...
      <div className="max-w-[1312px] border-t border-gray-700 mt-12 mx-auto px-6 pt-6">
